...
<x-layout>
 ...
 @include('includes.user_sidebar', ['requestStatus' => $requestStatus])
    <x-page-heading>All Products</x-page-heading>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Title</th>
                    <th>Category</th>
                    <th>Posted By</th> <!-- New column for user -->
                    <th>Image</th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color: black;">{{ $product->user->name }}</td> <!-- Display user name -->
                    <td>
                        @if($product->image)
                    ...
                    <td>
                        ...
                        <a href="/users/products/edit/{{$product->id}}" class="btn btn-warning btn-sm">Update</a>
