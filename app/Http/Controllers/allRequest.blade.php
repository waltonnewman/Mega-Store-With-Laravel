                        ...
                        <tr>
                           ...
                           <td>{{ $allrequest->business_name }}</td>
                            ...
                            <td>{{ $allrequest->created_at->format('Y-m-d') }}</td>
                              <td>
                                  <a href="{{ route('allrequest.show', ->id) }}" class="btn btn-info btn-sm">View</a>
                                 
                        <form action="{{ route('allrequest.destroy', $allrequest->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this order?');">
                            @csrf
                            @method('DELETE')
